"""Observation adapter from TREAD closed-loop vehicles to A2C input."""
...
def convert_tread_obs_to_a2c_obs(
    tread_obs: Any,
    env: Any = None,
    config: dict[str, Any] | None = None,
) -> np.ndarray:
    """Convert TREAD/highway-env state to A2C's 5x5 kinematics observation."""
    ...
    if vehicles_count != 5 or features_count != 5:
        raise ValueError(
            "A2C checkpoint expects a 5x5 kinematics observation; got "
