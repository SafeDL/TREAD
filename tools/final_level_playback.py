...
def _make_runner(
    ...
    *,
    ...
    runners = importlib.import_module(f"{subset_name}.src.closed_loop_runner")
    ...
    if event_type == "cut_in":
        return runners.ClosedLoopCutInRunner(sampler, config)
    return runners.ClosedLoopFollowingRunner(sampler, config)
...
def replay_final_level(
    ...
    *,
    ...
    runner = _make_runner(config, config_dir, subset_name=subset_name)
