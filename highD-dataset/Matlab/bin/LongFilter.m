...
% tracks_filter 只保留纵向跟随数据； tracks_long 只保留0~150米之内有效跟随数据； Result有效的跟随数据特征
...
argumentsInput.tracks = tracks_filter;
...
argumentsInput.maximumFrame = tracks_filter(end).finalFrame-1; % Maximum frame
