...
在首次正式运行前生成 `results/revision_highd_2026/frozen_inputs.json`。它至少记录：
...
- [ ] `results/revision_highd_2026/experiment_manifest.json` 可枚举所有计划单元、状态、配置、输入哈希和输出路径；
