...
def main() -> None:
    ...
    logger.info(
        (
            "Following subset summary: probability=%.8g se=%.3g "
    ...
    logger.info("Following SAIRL result output: %s", result_path)
    logger.info(
        (
            "Following subset actual simulated scenario count: "
    ...
    logger.info(
        (
            "Following subset input space: scenario_condition_dim=%s "
