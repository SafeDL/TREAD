...
def _diagnostics_for_actions(
    ...
    ref_kin = integrate_adversary_actions_torch(
        reference_actions,
        raw_context,
        ego_length,
        adv_length,
    ...
    risk, risk_diag = compute_king_risk(kin, cfg, ref_kin)
...
def _prefixed_plan_summary(
    ...
    mapping = {
        ...
        "min_relative_rss_margin": f"{prefix}_min_relative_rss_margin",
        "rss_violation_rate": f"{prefix}_rss_violation_rate",
        "raw_rss_objective": f"{prefix}_raw_rss_objective",
        "relative_rss_objective": f"{prefix}_relative_rss_objective",
        "delta_rss_objective": f"{prefix}_delta_rss_objective",
        "improper_rss_objective": f"{prefix}_improper_rss_objective",
...
def _make_tilted_plan_callback(
    *,
    ...
    def callback(
        ...
        tilted_runtime_cfg = dict(risk_tilted_config)
        tilted_runtime_cfg["reference_actions"] = prior_sample.raw_actions.to(
            device,
        ).detach()
        tilted_sample = sampler.sample(
            ...
            seed=local_seed,
            risk_tilted=True,
            risk_tilted_config=tilted_runtime_cfg,
        )
...
def _sample_receding_case(
    *,
    ...
    runner.rescore_rollout_pair(tilted_result, prior_result)
    ...
    for key in (
        ...
        "prior_min_relative_rss_margin",
        "prior_rss_violation_rate",
        ...
        "tilted_min_relative_rss_margin",
        "tilted_rss_violation_rate",
        "tilted_raw_rss_objective",
        "tilted_relative_rss_objective",
        "tilted_delta_rss_objective",
        "tilted_improper_rss_objective",
...
def _sample_summary(
    ...
    return {
        ...
        "prior_delta_rss_objective_mean": _array_mean(
            arrays,
            "prior_delta_rss_objective",
        ),
        "tilted_delta_rss_objective_mean": _array_mean(
            arrays,
            "tilted_delta_rss_objective",
        ),
        "tilted_improper_rss_objective_mean": _array_mean(
            arrays,
            "tilted_improper_rss_objective",
        ),
