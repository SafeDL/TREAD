...
class RSSConfig:
    ...
    def from_config(cls, config: dict) -> "RSSConfig":
        ...
        return cls(
            ...
            delta_temperature=float(cfg.get("delta_temperature", 1.0)),
            relative_safe_min=float(cfg.get("relative_safe_min", 1.0)),
            improper_temperature=float(cfg.get("improper_temperature", 1.0)),
        )
